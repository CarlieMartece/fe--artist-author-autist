    ...
    <main>
      <div id="Introduction">
        ...
        <div id="bio">
          ...
          <p>
            In 2019, a long-overdue autism diagnosis explained their former
            social barriers, and they started investigating careers suitable for
            an academically bright neurodivergent person. This led to their
            present <Link to={"/code"}>coding</Link> obsession, with several
            works in progress beyond this site. Their next goals are to learn
            another coding language, find suitable employment in a
            disability-friendly workplace, finish book five, create a new
            writers' app, and beat their present record of reciting two thousand
            digits of pi.
          </p>
        </div>
      </div>
